...
fn main() {
 let life = Some("Live with purpose and kindness");

 match life {
 Some(message) => println!("The meaning of life: {}", message),
 None => println!("Life is what you make of it."),
 }

 <>


 <a href="https://app.daily.dev/mahendradhamala"><img src="https://api.daily.dev/devcards/v2/PCW4SsqVXK19eS4ajGkvn.png?type=wide&r=w3i" width="652" alt="Mahendra Dhamala's Dev Card"/></a>
